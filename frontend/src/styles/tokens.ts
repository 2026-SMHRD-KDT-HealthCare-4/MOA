export const colors = {
  ...
  // 기록 탭(직접사용자) 캘린더 날짜 점 상태 색 — HistoryPage 전용.
  // 레드 미사용. 강조 테두리는 브랜드 코랄(#FF7955, 레드 아님).
  calendar: {
    emptyDot:    "#E4D7CF", // 녹음 안 한 과거/예정 날짜: 연한 중립 회갈색(부정 느낌 없음)
    todayBorder: "#FF7955", // 오늘·아직 녹음 안 함: 강조 테두리(브랜드 코랄)
  },
